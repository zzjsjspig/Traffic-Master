travelTimev3 <- function(startStation,endStation,time) {
  ...
  # 
  # plotFramelong <- melt(plotFrame, id="timeLabel")  # convert to long format
  # 
  # ggplot(data=plotFramelong,
  #        aes(x=timeLabel, y=value, colour=variable)) +
  #   geom_line()
  # 
  # ggplot(plotFrame, aes(timeLabel)) + 
  #   geom_step(aes(y = Max, colour = "var0")) + 
  #   geom_step(aes(y = Min, colour = "var1")) +
  #   geom_step(aes(y = Med, colour = "var2")) 
