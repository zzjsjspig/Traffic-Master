...
openfig('Flow_650.fig');
openfig('Flow_900.fig');
X_tick=(0:50:900)
plot(X_tick,tvh,'x',X_tick,tvh_25,'.')
xlabel('Different Values of Demand Flow (Number of Cars Per Hour)') 
ylabel('Total Vehicles Per Hour') 
legend("Without Contoller","With Controller") 
title("The Dependence of Total Delay on Controller Presence")

for i=1:19
    y(i)=-100*(tvh_25(i)-tvh(i))/(tvh(i))
end
plot(X_tick,y,"-x")
