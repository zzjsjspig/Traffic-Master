...
#get the distance in DONE
#full 2018, download the file and create a master  DONE
#do everything mainlane DONE
#a chart by day (sun to sat, by hour of day ), median DONE
#a chart by weekday vs holiday vs weekend (median) DONE
#a chart by month? seasonality, keep the x axis as hours, one chart for weekend, one chart for weekday
